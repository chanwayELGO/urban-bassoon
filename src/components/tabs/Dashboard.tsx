...
export function Dashboard({ trip, itinerary, packing, expenses, baseCurrency, memories, weatherData, fetchWeather, navigateTo, toggleActivity, removeActivity, onQuickExpense, onQuickMemory }) {
  ...
  const generateBrief = async () => {
    ...
    try {
      ...
      // 4. Call Claude
      const data = { content: [{ text: await callAi({ task: 'brief', system: `You are a world-class travel concierge generating a personalised departure day brief. Return ONLY valid JSON — no markdown.
...
export const escICS = s => String(s||"")
